    ...
    <div className="flex flex-no-wrap h-screen">
      <div className="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
        <div className="overflow-y-scroll px-8">
          <div className="sticky top-0 z-50 h-16 w-full flex items-center bg-gray-800">
            <svg
            ...
            <Link to="/bubble-sort">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Bubble sort</span>
                </div>
              </li>
            </Link>
            <Link to="/insertion-sort">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Insertion sort</span>
                </div>
              </li>
            </Link>
            <Link to="/recursion">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Recursion</span>
                </div>
              </li>
            </Link>
            <Link to="/merge-sort">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Merge sort</span>
                </div>
              </li>
            </Link>
            <Link to="/quick-sort">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Quick sort</span>
                </div>
              </li>
            </Link>
            <Link to="/radix-sort">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Radix sort</span>
                </div>
              </li>
            </Link>
            <Link to="/binary-search">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Binary search</span>
                </div>
              </li>
            </Link>
            <Link to="/array-list">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Array list</span>
                </div>
              </li>
            </Link>
            <Link to="/linked-list">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Linked list</span>
                </div>
              </li>
            </Link>
            <Link to="/binary-search-tree">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Binary search tree</span>
                </div>
              </li>
            </Link>
            <Link to="/self-balancing-avl-tree">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-sm  ml-2">Self Balancing AVL tree</span>
                </div>
              </li>
            </Link>
            <Link to="/avl-tree">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">AVL trees</span>
                </div>
              </li>
            </Link>
            <Link to="/depth-first-tree-transversals">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <Link to="/heap-sort">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Heap sort</span>
                </div>
              </li>
            </Link>
            <Link to="/graphs">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Graphs</span>
                </div>
              </li>
            </Link>
            <Link to="/pathfinding">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Pathfinding</span>
                </div>
              </li>
            </Link>
            <Link to="/tries">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Tries</span>
                </div>
              </li>
            </Link>
            <Link to="/bloom-filters">
              <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-sm  ml-2">Bloom Filters</span>
                </div>
              </li>
            </Link>
          </ul>
